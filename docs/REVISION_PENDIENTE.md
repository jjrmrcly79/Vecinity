...
| Residente | Reportar incidencia (con foto) | ✅ — reporte (infractor por casa **o placa**) + evidencia a Storage + resolución comité con monto por reincidencia (2026-06-23). **Evidencia confiable (2026-06-27):** cámara forzada + hora sellada por servidor + geo opcional → alimenta el **reporte de multas con IA** (Claude). **OCR + multa semi-automática (2026-06-27):** ✅ visión Claude lee la placa → match 3 vías (OCR vs reportada vs `vehicles`) → 1ª vez amonestación, reincidencia → propuesta que el comité aprueba con **1 voto**; notifica al infractor. Falta: OCR en caseta (post-lanzamiento) |
| Residente | Paquetes, propuestas/votos, marketplace, comunidad | ❌ |
| Vigilante | **Vista completa** (entrada/salida visitas, placas, paquetes, turnos, ciclo de llave de reservas, **servicios generales + recurrentes con foto**) | ✅ — `/vigilancia` (2026-06-23). **Caseta cerrada (2026-06-27):** ✅ registro manual de visita (walk-in) · ✅ fotos INE/placas · ✅ historial del día · ✅ **OCR de placas** (visión Claude lee la placa de la foto al registrar). Falta (post-lanzamiento): OCR en pase QR, gafetes |
| Comité/Admin | Aprobar pagos/vehículos, resolver multas, generar cobros, gastos, finanzas | ⚠️ ✅ aprobar vecinos · ✅ vehículos · ✅ abonos · ✅ áreas/reservas · ✅ resolver incidencias · ✅ **Panel del comité** (pendientes+finanzas+morosos) · ✅ anti-duplicado de comprobante por hash. ✅ **generar cobros mensuales** + recargos · ✅ **convenios de pago (seguimiento semanal)** · ✅ **gastos + dashboard por categoría + export CSV** · ✅ **conciliación bancaria** (sube .xlsx BBVA → asigna abonos a casa, mapa aprendido + dedup) (2026-06-27). Falta: detección de multas en conciliación, importar egresos del estado de cuenta, censo |
